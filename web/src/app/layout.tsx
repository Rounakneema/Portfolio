...
export const metadata: Metadata = {
  title: 'Rounak Neema — Cybersecurity, Cloud & AI Systems Engineer',
  ...
  openGraph: {
    ...
    title: 'Rounak Neema — Cybersecurity, Cloud & AI Systems Engineer',
    description: 'Rounak Neema builds security tooling, cloud-native infrastructure, AI systems, and distributed backends.',
