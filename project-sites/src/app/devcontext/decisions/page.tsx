        ...
        <main className="min-h-screen bg-[#0a0a0a] text-[#e0e0e0] font-mono selection:bg-[#fff] selection:text-[#000] overflow-x-hidden">
            ...
            <header className="p-4 md:p-8 border-b border-[#333] flex flex-col md:flex-row justify-between items-start md:items-center text-xs uppercase tracking-widest gap-4">
                <div className="flex gap-4">
                    <span className="text-white bg-[#222] px-2 py-1">Ref: devcontext/decisions</span>
                </div>
                <nav className="flex gap-6 border-l border-[#333] pl-6">
                    ...
                    <Link href="/devcontext/decisions" className="text-white border-b border-white hover:text-white transition-colors">Decisions</Link>
                </nav>
            </header>
            ...
            <section className="p-4 md:p-8 lg:p-16 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    <div className="lg:col-span-8 prose prose-invert prose-p:text-[#aaa] prose-headings:text-white prose-a:text-white max-w-none">
                        ...
                        <h2 className="text-2xl uppercase tracking-widest border-b border-[#333] pb-4 mb-8">AI Grounding Logic</h2>
                        <p>
                        ...
                        <h2 className="text-2xl uppercase tracking-widest border-b border-[#333] pb-4 mb-8 mt-16">Multi-Model AI Routing</h2>
                        <p>
                        ...
                        <ul className="space-y-4 my-8 list-none pl-0">
                            <li className="bg-[#111] p-4 border-l-2 border-[#555]">
                                <strong className="text-white block mb-2">Stage 1 (Code Review) & Stage 2 (Intelligence)</strong>
                            ...
                            <li className="bg-[#111] p-4 border-l-2 border-[#555]">
                                <strong className="text-white block mb-2">Stage 3 (Interview Real-Time Evaluation)</strong>
                        ...
                        <h2 className="text-2xl uppercase tracking-widest border-b border-[#333] pb-4 mb-8 mt-16">Trade-off: Serverless Cold Starts vs Idle Costs</h2>
                        <p>
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <div className="bg-[#050505] border border-[#222] p-6">
                            <div className="text-xs text-[#666] uppercase mb-4 border-b border-[#333] pb-2">Cost Metrics</div>
                            <div className="space-y-4">
                                <div>
                                    <div className="text-[#888] text-sm">Avg Tokens / Repo</div>
                                    <div className="text-white text-xl font-bold">~55,000</div>
                                </div>
                                <div>
                                    <div className="text-[#888] text-sm">Cost / Analysis</div>
                                    <div className="text-white text-xl font-bold">~$1.42</div>
                                </div>
                                <div>
                                    <div className="text-[#888] text-sm">SLA Time-to-First-Byte</div>
                                    <div className="text-white text-xl font-bold">&lt; 30s</div>
                                </div>
                            </div>
                        </div>

                        <div className="bg-[#050505] border border-[#222] p-6 font-mono text-[10px] text-[#888]">
                            <div className="text-white mb-2">// Grounding Assertion Snippet</div>
