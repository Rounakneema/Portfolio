    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-mono selection:bg-white selection:text-black">
      ...
      <main className="p-6 md:p-12 lg:p-24 overflow-hidden">
        ...
        <section className="mb-32 grid grid-cols-1 md:grid-cols-3 gap-8">
          <Link href="/architecture" className="group border-4 border-white p-8 hover:bg-white hover:text-black transition-all duration-300 block">
          ...
          <Link href="/decisions" className="group border-4 border-white p-8 hover:bg-white hover:text-black transition-all duration-300 block">
          ...
          <Link href="/docs" className="group border-4 border-white p-8 hover:bg-white hover:text-black transition-all duration-300 block">
