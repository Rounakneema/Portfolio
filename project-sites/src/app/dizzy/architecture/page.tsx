...
<section className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed leading-relaxed leading-relaxed">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-white tracking-tight tracking-tight">2. Agentic Orchestrator</h3>
            <p className="text-gray-400 leading-relaxed leading-relaxed leading-relaxed">
          ...
          <div className="space-y-6 md:col-span-2">
            <h3 className="text-2xl font-bold text-white tracking-tight tracking-tight">3. Semantic Buffer & MCP</h3>
            <p className="text-gray-400 leading-relaxed leading-relaxed leading-relaxed">
