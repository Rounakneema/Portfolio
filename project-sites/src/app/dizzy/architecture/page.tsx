...
<header className="mb-16 relative z-10">
      ...
      <main className="relative z-10 space-y-24">
        ...
        <ScrollReveal direction="up" delay={0.1}>
<section>
          <h2 className="text-3xl font-bold mb-8 uppercase text-white border-l-4 border-[#ff3366] pl-4 tracking-tight">Topology Overview</h2>
...
<section className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-white tracking-tight">1. JEV Voice Gateway</h3>
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-white tracking-tight">2. Agentic Orchestrator</h3>
            <p className="text-gray-400 leading-relaxed leading-relaxed">
          ...
          <div className="space-y-6 md:col-span-2">
            <h3 className="text-2xl font-bold text-white tracking-tight">3. Semantic Buffer & MCP</h3>
            <p className="text-gray-400 leading-relaxed leading-relaxed">
