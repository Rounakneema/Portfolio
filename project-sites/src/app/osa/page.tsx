...
export default function OSAPage() {
    ...
    return (
        <main className="min-h-screen bg-[#050505] text-[#e0e0e0] font-mono selection:bg-[#fff] selection:text-[#000] overflow-x-hidden">
            ...
            {/* HEADER */}
            <header className="px-6 py-12 md:py-24 border-b-4 border-[#333] grid-bg">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
                        <h1 className="text-6xl md:text-9xl font-black uppercase tracking-tighter text-glitch" data-text={project.title}>
                            {project.title}
                        </h1>
                    ...
                    <div className="mt-12 flex flex-wrap gap-4">
                        {project.tags.map((tag, i) => (
                            <span key={i} className="px-4 py-2 text-sm md:text-base border border-gray-600 uppercase tracking-widest">
                                {tag.text}
                            </span>
                        ))}
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-5 space-y-16">
                    <section>
                        <h2 className="text-xs uppercase tracking-[0.2em] text-gray-500 mb-6 border-b border-gray-800 pb-2">The Challenge</h2>
                    ...
                    <section>
                        <h2 className="text-xs uppercase tracking-[0.2em] text-gray-500 mb-6 border-b border-gray-800 pb-2">The Solution</h2>
                    ...
                    <section>
                        <h2 className="text-xs uppercase tracking-[0.2em] text-gray-500 mb-6 border-b border-gray-800 pb-2">Metrics</h2>
                ...
                <div className="lg:col-span-7 space-y-16">
                    ...
                    <section>
                        <h2 className="text-xs uppercase tracking-[0.2em] text-gray-500 mb-6 border-b border-gray-800 pb-2">Architecture & Execution</h2>
                        <div className="editorial-column text-gray-300 leading-relaxed text-lg">
                            {project.fullDescription}
                        </div>
                    </section>

                    <section className="brutalist-border p-8">
                        <h2 className="text-xs uppercase tracking-[0.2em] text-gray-500 mb-8 border-b border-gray-800 pb-2">Capabilities</h2>
                        <ul className="space-y-6">
                            {project.bullets.map((b, i) => (
                                <li key={i} className="flex gap-4">
                                    <span className="text-[#fff] font-bold">{(i+1).toString().padStart(2, '0')}.</span>
                                    <div>
            ...
            {/* FOOTER */}
            <footer className="px-6 py-12 border-t border-[#333] mt-24">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="text-sm text-gray-500 uppercase tracking-widest">
                        SYS.END // {project.slug.toUpperCase()}
                    </div>
                    <Link href="/" className="px-8 py-4 border-2 border-white hover:bg-white hover:text-black transition-colors font-bold uppercase tracking-widest text-sm">
                        Return to Index
                    </Link>
                </div>
            </footer>
