                ...
                <ScrollReveal direction="up" delay={0.1}>
                    <section className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        <div className="lg:col-span-4">
                            <h2 className="text-xl font-bold uppercase tracking-tight text-[#ffb800] mb-4">
                        ...
                        <div className="lg:col-span-8 brutalist-border p-8 bg-[#050505] hover:-translate-y-1 hover:border-[#ffb800] transition-all duration-300">
                            <h3 className="text-lg font-bold tracking-tight text-[#fff] mb-4">The Single Binary / Sidecar Model</h3>
                            ...
                            <div className="code-trace bg-white/5 border border-white/10 backdrop-blur-md rounded-lg p-6 shadow-xl text-[#e0e0e0]">
<pre>
...
func GenerateSelfSignedCerts() error {
    ...
    // In-memory generation avoids relying on PKI infrastructure
                ...
                <ScrollReveal direction="up" delay={0.1}>
                    <section className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        <div className="lg:col-span-4">
                            <h2 className="text-xl font-bold uppercase tracking-tight text-[#ef4444] mb-4">
                        ...
                        <div className="lg:col-span-8 brutalist-border p-8 bg-[#050505] hover:-translate-y-1 hover:border-[#ffb800] transition-all duration-300">
                            <h3 className="text-lg font-bold tracking-tight text-[#fff] mb-4">Algorithmic Fast-Path</h3>
                            <p className="text-gray-300 leading-relaxed mb-6">
                ...
                <ScrollReveal direction="up" delay={0.1}>
                    <section className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        <div className="lg:col-span-4">
                            <h2 className="text-xl font-bold uppercase tracking-tight text-[#e0e0e0] mb-4">
                        ...
                        <div className="lg:col-span-8 brutalist-border p-8 bg-[#050505] hover:-translate-y-1 hover:border-[#ffb800] transition-all duration-300">
                            <h3 className="text-lg font-bold tracking-tight text-[#fff] mb-4">Statistical Machine Learning</h3>
                            <p className="text-gray-300 leading-relaxed mb-6">
                            ...
                            <StaggerContainer>
                                <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-6 marker:text-[#ef4444]">
                                    <StaggerItem><li>Shannon Entropy Density</li></StaggerItem>
                                    <StaggerItem><li>Character Set Distribution (Z-Score outliers)</li></StaggerItem>
                                    <StaggerItem><li>Contextual keywords (e.g., proximity to "Bearer")</li></StaggerItem>
                                </ul>
                            </StaggerContainer>
