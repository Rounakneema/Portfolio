            ...
            <div className="max-w-6xl mx-auto px-6 py-20 md:px-10">
                <ScrollReveal direction="up" delay={0.1}>
                    <section className="mb-16">
                        ...
                        <h1 className="text-2xl font-black tracking-tight text-white mb-6">Timing & Ethics</h1>
                ...
                <ScrollReveal direction="up" delay={0.1}>
                    <section className="rounded-xl border border-rose-500/30 bg-rose-500/5 p-6 md:p-8 mb-16 flex gap-4 md:gap-6 items-start">
                        <ShieldAlert className="h-8 w-8 text-rose-400 shrink-0 mt-1" />
                        <div>
                            <h2 className="text-lg font-bold tracking-tight text-rose-200 mb-2">Legal Authorization Required</h2>
                        ...
                        <StaggerContainer className="grid md:grid-cols-2 gap-6">
                            {scanProfiles.map(p => (
                                <StaggerItem key={p.name}>
                                    <div className="bg-white/5 border border-white/10 backdrop-blur-md rounded-lg shadow-xl p-6 transition-all duration-300 hover:border-white/20 hover:-translate-y-1">
                                        ...
                                        <code className="block text-xs font-mono text-zinc-500 bg-white/5 border border-white/10 backdrop-blur-md rounded-lg shadow-xl px-3 py-2 mb-4">{p.flag}</code>
                ...
                <ScrollReveal direction="up" delay={0.1}>
                    <div className="mt-16 flex justify-end">
                        <Link href="/docs" className="group flex items-center gap-2 text-xs font-bold uppercase tracking-[0.1em] text-lime-300 hover:text-lime-200 hover:-translate-y-1 transition-all duration-300">
