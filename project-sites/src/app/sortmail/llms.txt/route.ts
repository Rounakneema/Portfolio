...
## Overview
SortMail is a technical project developed by Rounak Neema.
- Official Domain: https://sortmail.rounakneema.in
- Author: Rounak Neema (https://rounakneema.in)
- Source Repository: https://github.com/rounakneema/sortmail
